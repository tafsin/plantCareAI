...
String reminderNotificationPayload(Reminder reminder) =>
    '/plants/${Uri.encodeComponent(reminder.plantId)}/reminders/'
    '${Uri.encodeComponent(reminder.id)}';
...
final class LocalNotificationScheduler implements NotificationScheduler {
  ...
  Future<void> schedule({
    ...
    await _plugin.zonedSchedule(
      ...
      body: body,
      payload: reminderNotificationPayload(reminder),
